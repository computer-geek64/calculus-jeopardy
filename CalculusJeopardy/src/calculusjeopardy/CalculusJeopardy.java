...
public class CalculusJeopardy {
    ...
    public static void main(String[] args) {
        ...
        questions = new String[][] {
            {"The expression x<sup>2</sup>+5x-13 has this derivative.", "The expression 4x<sup>4</sup>+5x-7 has an antiderivative of this.", "The function f(x)=3x<sup>2</sup>+6x-7 has a relative this at x=-1.", "The function f(x)=x<sup>2</sup>-7x-3 is concave in this direction at the point (2,-13)."}, // 200
        ...
        finalJeopardyQuestion = "Given the function f(x)=[ln(3x)]/(x<sup>2</sup>), f approaches this value as x approaches &infin;.";
